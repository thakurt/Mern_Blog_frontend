...
export default function Individualpost() {
    ...
    useEffect(()=>{
        const getPost = async()=>{
            const res = await axios.get("https://mernblogmern.herokuapp.com/api/post/" + path)
            setPost(res.data)
    ...
    const handleDelete = async()=>{
        try {
            await axios.delete(`https://mernblogmern.herokuapp.com/api/post/${post._id}`, 
            {
    ...
    const handleUpdate = async()=>{
        try {
            await axios.put(`https://mernblogmern.herokuapp.com/api/post/${post._id}`,{
